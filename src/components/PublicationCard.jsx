...
export default function PublicationCard({type, title, authors, year, link }) {
    return (
        <div className="bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition duration-300 text-left space-y-2">
            <h3 className="inline-block px-3 py-1 rounded-full text-xs font-medium mb-3 text-[#204E67] bg-[#80CBC4]">{type}</h3>
            ...
            {link && (
                <a 
                    ...
                    className="mt-2 px-4 py-4 text-[#204E67] hover:text-[#DD994D] transition"
                >
                    Read more  →
                </a>
            )}
