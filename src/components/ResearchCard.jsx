...
export default function ResearchCard({ type, title, link, authors }) {
  return (
    <div className="bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition duration-300 text-left space-y-2">
      <h3 className="inline-block px-3 py-1 rounded-full text-xs font-medium mb-3 text-[#204E67] bg-[#80CBC4]">
        {type}
      </h3>
      ...
      {link && (
        <a
          ...
          className="inline-block mt-2 px-4 py-2 bg-[#204E67] text-white rounded hover:bg-[#DD994D] transition"
        >
          View More
        </a>
      )}
